// Define an array object: Array that contains objects
const employees = [
...
// We create a function to display all employees --- employees.map(ArrowFunc)
...
// We create a function to display total salaries 
...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) { // if foundEmployee is an object?
